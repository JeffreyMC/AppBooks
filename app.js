...
class UI {
    ...
    //muestra un mensaje al agregqar o al eliminar un libro
    static mostrarAlerta(mensaje, className) {
        ...
        const form = document.querySelector('#libros-form');
...
//clase que maneja los datos en el localStorage
class Datos {
    static traerLibros() {
        let libros;
...
//Muestra los libros al cargar la página
document.addEventListener('DOMContentLoaded', UI.mostrarLibros());

//Controlar el Evento Submit sin datos.
document.querySelector('#libros-form').addEventListener('submit', (e) => {
    e.preventDefault();
...
//elimina el libro al presionar en la X
